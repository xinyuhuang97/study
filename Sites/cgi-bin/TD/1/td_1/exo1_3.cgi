...
Je suis le script <a href='www.apache.org/SCRIPT_NAME'>$SCRIPT_NAME</a>
servi par <a href='www.apache.org/SERVER_SOFTWARE'>$SERVER_SOFTWARE</a>
pour <a href='www.apache.org/HTTP_USER_AGENT'>$HTTP_USER_AGENT</a>.
</div></body></html>
EOF
